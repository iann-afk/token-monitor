...
const ClaudePlatform = (function () {
  ...
  const MODELS = {
    'sonnet-4-7':  { id: 'claude-sonnet-4-7', displayName: 'Sonnet 4.7', contextWindow: 200000, maxOutputTokens: 8192,  burnRateMultiplier: 1.0 },
    'sonnet-4-6':  { id: 'claude-sonnet-4-6', displayName: 'Sonnet 4.6', contextWindow: 200000, maxOutputTokens: 8192,  burnRateMultiplier: 1.0 },
    'opus-4-7':    { id: 'claude-opus-4-7',   displayName: 'Opus 4.7',   contextWindow: 200000, maxOutputTokens: 8192,  burnRateMultiplier: 5.0 },
    'opus-4-6':    { id: 'claude-opus-4-6',   displayName: 'Opus 4.6',   contextWindow: 200000, maxOutputTokens: 8192,  burnRateMultiplier: 5.0 },
    'haiku-4-5':   { id: 'claude-haiku-4-5',  displayName: 'Haiku 4.5',  contextWindow: 200000, maxOutputTokens: 8192,  burnRateMultiplier: 0.2 },
    'unknown':     { id: 'unknown',           displayName: 'Unknown',    contextWindow: 200000, maxOutputTokens: 8192,  burnRateMultiplier: 1.0 },
  };
  ...
  function getActiveModel() {
    ...
    if (btn) {
      ...
      if (versionMatch) {
        ...
        if (MODELS[candidate]) {
          ...
          const latest = Object.keys(MODELS)
    ...
    return { ...MODELS[key], extendedThinking };
  }
